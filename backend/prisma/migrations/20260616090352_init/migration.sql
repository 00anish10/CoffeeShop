...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'BREWING', 'READY', 'DELIVERED', 'CANCELLED');
...
CREATE TABLE "Product" (
    ...
    "preparationMinutes" INTEGER NOT NULL DEFAULT 5,
...
CREATE TABLE "Order" (
    ...
    "tableNumber" INTEGER,
    "isTableOrder" BOOLEAN NOT NULL DEFAULT false,
    "paymentStatus" "PaymentStatus" NOT NULL DEFAULT 'PENDING',
    "stripePaymentIntentId" TEXT,
    "brewStartedAt" TIMESTAMP(3),
